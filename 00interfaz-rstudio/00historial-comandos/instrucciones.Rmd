...
A medida que trabajes con R, a menudo necesitarás recuperar comandos que has 
introducido anteriormente. La consola de RStudio nos proporciona la funcionalidad
de recuperar comandos mediante el uso de las teclas:

- __Up__: Recupera comando(s) anteriores
...
Además, podemos utilizar el mismo atajo de teclado para buscar comando que coinciden con un 
...
**Pregunta:**
Utiliza lo que has aprendido en el video y la sección anterior para recuperar
el comando del historial que calculaba la media del vector.
...
<span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span></a>
</p>
